...
public class HadoopRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public HadoopRecord(CharSequence InvoiceNumber, Long CreatedTime, CharSequence StoreID, CharSequence PosID, CharSequence CustomerType, CharSequence PaymentMethod, CharSequence DeliveryType, CharSequence City, CharSequence State, CharSequence PinCode, CharSequence ItemCode, CharSequence ItemDescription, Double ItemPrice, Integer ItemQty, Double TotalValue) {
  ...
  public void put(int field$, Object value$) {
    ...
    case 2: StoreID = (CharSequence)value$; break;
    case 3: PosID = (CharSequence)value$; break;
    case 4: CustomerType = (CharSequence)value$; break;
    case 5: PaymentMethod = (CharSequence)value$; break;
    case 6: DeliveryType = (CharSequence)value$; break;
    case 7: City = (CharSequence)value$; break;
    case 8: State = (CharSequence)value$; break;
    case 9: PinCode = (CharSequence)value$; break;
    case 10: ItemCode = (CharSequence)value$; break;
    case 11: ItemDescription = (CharSequence)value$; break;
   ...
   * @return A new HadoopRecord RecordBuilder
   */
  public static Builder newBuilder(HadoopRecord other) {
    return new Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HadoopRecord>
     ...
     * @param other The existing instance to copy.
     */
    private Builder(HadoopRecord other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.InvoiceNumber)) {
        this.InvoiceNumber = data().deepCopy(fields()[0].schema(), other.InvoiceNumber);
        fieldSetFlags()[0] = true;
    ...
    public HadoopRecord build() {
      try {
        ...
        record.StoreID = fieldSetFlags()[2] ? this.StoreID : (CharSequence) defaultValue(fields()[2]);
        record.PosID = fieldSetFlags()[3] ? this.PosID : (CharSequence) defaultValue(fields()[3]);
        record.CustomerType = fieldSetFlags()[4] ? this.CustomerType : (CharSequence) defaultValue(fields()[4]);
        record.PaymentMethod = fieldSetFlags()[5] ? this.PaymentMethod : (CharSequence) defaultValue(fields()[5]);
        record.DeliveryType = fieldSetFlags()[6] ? this.DeliveryType : (CharSequence) defaultValue(fields()[6]);
        record.City = fieldSetFlags()[7] ? this.City : (CharSequence) defaultValue(fields()[7]);
        record.State = fieldSetFlags()[8] ? this.State : (CharSequence) defaultValue(fields()[8]);
        record.PinCode = fieldSetFlags()[9] ? this.PinCode : (CharSequence) defaultValue(fields()[9]);
        record.ItemCode = fieldSetFlags()[10] ? this.ItemCode : (CharSequence) defaultValue(fields()[10]);
        record.ItemDescription = fieldSetFlags()[11] ? this.ItemDescription : (CharSequence) defaultValue(fields()[11]);
