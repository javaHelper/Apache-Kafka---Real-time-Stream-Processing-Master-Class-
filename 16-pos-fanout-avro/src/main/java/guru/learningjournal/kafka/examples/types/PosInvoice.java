...
public class PosInvoice extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -7841300377537137280L;
   ...
   */
  public PosInvoice(CharSequence InvoiceNumber, Long CreatedTime, CharSequence CustomerCardNo, Double TotalAmount, Integer NumberOfItems, CharSequence PaymentMethod, Double TaxableAmount, Double CGST, Double SGST, Double CESS, CharSequence StoreID, CharSequence PosID, CharSequence CashierID, CharSequence CustomerType, CharSequence DeliveryType, guru.learningjournal.kafka.examples.types.DeliveryAddress DeliveryAddress, java.util.List<LineItem> InvoiceLineItems) {
  ...
  public void put(int field$, Object value$) {
    ...
    case 2: CustomerCardNo = (CharSequence)value$; break;
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PosInvoice>
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setDeliveryAddress(guru.learningjournal.kafka.examples.types.DeliveryAddress value) {
     ...
     * @return This builder.
     */
    public Builder setDeliveryAddressBuilder(guru.learningjournal.kafka.examples.types.DeliveryAddress.Builder value) {
    ...
    public PosInvoice build() {
      try {
        ...
        record.CustomerCardNo = fieldSetFlags()[2] ? this.CustomerCardNo : (CharSequence) defaultValue(fields()[2]);
